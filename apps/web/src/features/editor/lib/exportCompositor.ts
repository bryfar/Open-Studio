import type { BackgroundStyle, Clip, MediaFile, Project } from '@/shared/types';
import { DEFAULT_SCREEN_CURSOR } from '@/shared/types';
import { getClipEffectiveMediaTime, interpolateCamera, interpolateKeyframes } from '@/features/editor/lib/animation';
import {
...
} from '@/features/editor/lib/clipPreviewStyle';
import { resolveBackgroundAtTime } from '@/features/editor/lib/sceneTimeline';
import { calculateSmoothZoom } from '@/features/editor/lib/zoomEngine';
import { drawScreenCursor, interpolateCursorAtTime } from '@/features/editor/lib/cursorOverlay';
