...
export interface Project {
  ...
  audioPro?: {
    ...
    buses: Array<{ id: string; name: string; gainDb: number }>;
  };
  timelinePro?: {
    rippleEdit: boolean;
    slipMode: boolean;
    ...
    trackTargeting: { video: boolean; audio: boolean; text: boolean };
  };
  multicam?: {
    enabled: boolean;
    activeAngle: number;
    ...
    angleCuts?: Array<{ id: string; time: number; angle: number }>;
  };
  subtitles?: {
    cues: Array<{
      id: string;
