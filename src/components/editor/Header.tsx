...
import type { Project, Clip, MediaFile, SocialExportPlatform } from '@/types';
import { scheduleMediaFileMetadataProbe } from '@/lib/scheduleMediaProbe';
import { renderCompositedWebM } from '@/lib/exportCompositor';
import { SOCIAL_VARIANTS_BY_PLATFORM, resolveSocialProfile } from '@/lib/socialExport';
...
export function Header() {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = `${project.name || 'open-studio-export'}.${exportFormat}`;
