...
import {
  ...
  FILTER_PRESETS,
  TRANSITION_PRESETS,
} from '@/lib/motionCatalog';
import type { TimeRemapKeyframe, BackgroundStyle, Clip, ClipMediaLayout } from '@/types';
import { ProjectLienzoPanel } from '@/components/editor/ProjectLienzoPanel';
import {
...
import { defaultProjectBackground, findBackgroundEditTarget } from '@/lib/sceneTimeline';
import {
  applyScreenCursorStylePreset,
  SCREEN_CURSOR_STYLE_PRESETS,
} from '@/lib/projectStylePresets';
import { isFaceDetectorSupported } from '@/lib/faceFraming';
